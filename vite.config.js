  ...
  build: {
    rollupOptions: {
      input: {
        ...
        ytCoursesFCC: resolve(__dirname, 'JS/YTCourses/FCC/index.html'),
        ...
        ytCoursesFrankLabsCoursePart09: resolve(__dirname, 'JS/YTCourses/FrankLabsCourse/Part09/index.html'),
        ytCoursesFrankLabsCoursePart10: resolve(__dirname, 'JS/YTCourses/FrankLabsCourse/Part10/index.html'),
        ytCoursesFrankLabsCoursePart11: resolve(__dirname, 'JS/YTCourses/FrankLabsCourse/Part11/index.html'),
        ytCoursesFCCPolyrythms: resolve(__dirname, 'JS/YTCourses/FCC/Polyrythms/index.html'),
        ytCoursesFCCProAudioAIGame: resolve(__dirname, 'JS/YTCourses/FCC/ProAudio-AIGame/index.html'),
        ytCoursesFCCAIGame: resolve(__dirname, 'JS/YTCourses/FCC/AIGame/index.html'),
        ytCoursesFCCAIGameP1_9: resolve(__dirname, 'JS/YTCourses/FCC/AIGameP1_9/index.html'),
