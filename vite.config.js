  ...
  build: {
    rollupOptions: {
      input: {
        ...
        ytCoursesFreeCodeCamp: resolve(__dirname, 'src/JS/YTCourses/FCC/index.html'),
        ...
        ytCoursesFreeCodeCamp: resolve(__dirname, 'src/JS/YTCourses/FCC/Polyrythms/index.html'),
